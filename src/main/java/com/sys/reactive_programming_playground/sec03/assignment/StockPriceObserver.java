package com.sys.reactive_programming_playground.sec03.assignment;
...
public class StockPriceObserver implements Subscriber<Integer> {
    ...
    public void onNext(Integer price) {
        if(price < 90 && balance >= price){
            quantity++;
            balance-=price;
            log.info("bought a stock {}, total quantity : {}, remaining balance : {}", price, quantity, balance);
